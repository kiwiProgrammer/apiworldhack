...
public class WebActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView mImageView = (ImageView) findViewById(R.id.fullscreen_Image);

        WebSettings webSettings = mContentView.getSettings();
        webSettings.setJavaScriptEnabled(true);

        mContentView.loadUrl("file:///android_asset/website.html");
        ...
        {
            // get input stream
            InputStream ims = getAssets().open(IMAGES[0]);
            ...
            public void onClick(View view) {
                ...
                try
                {
                    if (index < IMAGES.length) {
                        // get input stream
                        InputStream ims = getAssets().open(IMAGES[index]);
                        // load image as Drawable
                        Drawable d = Drawable.createFromStream(ims, null);
                        // set image to ImageView
